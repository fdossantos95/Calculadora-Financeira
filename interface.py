...
layout = [
    ...
    [sg.Text('MDR Débito',size=(1,1)),sg.Input(key='mdr_debito_fast'),sg.Input(key='mdr debito normal')],
    ...
    [sg.Text('Modalidade'),sg.Text('FAST'),sg.Text('NORMAL')],
    [sg.Text('Débito'),sg.Input(key=(f'mdr_debito_fast')),     sg.Input(key='debito normal')],
